...
* 뽑는 입장이 한 번이라도 되어본 적이 있다면, 회사에서 필요한 사람이 바로 자신임을 어필하는 것이 중요하다는 것을 알 수 있다.
  * 모든 것은 **직무 적합성**으로 통한다.
    ...
    * 회사에서는 지원자가 새로운 것을 학습하는 속도를 현재 가진 기술 및 지식의 수준보다 더 중요하게 본다.
  ...
  * 면접관을 미소 짓게 만들 줄 아는 호감형 사람들이 조금은 더 유리할 수 있다.
...
* 내가 이 회사와 잘 맞을지 끊임없이 고민해야 한다.
  ...
  * 개인적인 생각으로, 취업 과정은 있는 그대로의 내가 가장 빛날 수 있는 회사를 찾는 과정이다.
    ...
    * 나와 잘 맞는 회사에서는 동료들이 내 능력을 인정해 주고 나를 필요로 한다.
...
* 맡은 직무를 통해 추구하고자 하는 가치가 자신이 가진 가치관과 일치하는지가 굉장히 중요하다.
  ...
  * **내가 가장 열정을 쏟고 싶은 일이 회사에서 맡은 일과 같아질 수 있을지 고민해보게 된다.**
    ...
    * 이러한 자기실현(자기일치)적 목표를 세울 수 있다면 최적의 회사, 최적의 직무를 찾은 것이며, 더 행복해질 수 있다.
    * 워라밸은 회사에서의 자기실현이 불가능할 때 고려하게 되는 차선의 목표라고 생각한다.
...
* Unity & C# 스크립팅
  ...
  * ["C#에서 `struct`와 `class` 인스턴스가 어떻게 다른가요?"](#c-struct와-class-인스턴스의-차이)
...
* 재사용 가능 오브젝트 풀 (object pool 패턴)
  ...
  * *그러나 오랫동안 쓰지 않을 게임오브젝트는 unload하는 것이 좋다.*
* 컬렉션과 배열 재사용
